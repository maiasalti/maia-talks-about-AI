...
On the flight back, he did the math. What is a rocket actually made of? Aluminum, titanium, copper, carbon fiber. He worked out that the raw materials that go into a rocket cost around 2% of what SpaceX customers were being charged for a finished one. If materials were 2% of the price, the other 98% was everyone else's margin, decades of an industry that had never been forced to get cheaper.
...
Instead, every company's most expensive currently-available model shoots back up, again and again, at almost every major release, even as its older, cheaper tiers kept getting cheaper alongside it.
...
Rather than turn "price ÷ compute cost" into a single number per model, I calculated it at both ends of that 2-cent-to-$4.20 range: once assuming compute costs as much as $4.20 (the lower, most charitable bound), and once assuming it costs as little as 2 cents (the upper, least charitable bound). I want to be upfront that neither end is more "correct" than the other; the honest number for any of these models sits somewhere in between, and I don't have the data to say exactly where. What's useful is looking at both.

<IdiotIndexChart />

Under the charitable bound, GPT-5.5 comes out to about 7x, Opus 4.8 about 6x, and Gemini 3.1 Pro Preview about 3x, all under the illustrative 10x line that online summaries of Isaacson's book attribute to Musk as a rough "build it yourself" cutoff (worth flagging: I couldn't verify that specific number as an actual Musk quote, so treat it as a rule of thumb, not a bright line he actually drew). Only Fable 5, at about 12x, clears it. Under the uncharitable bound, every model clears it by a wide margin, including DeepSeek's V4 Pro, whose upper bound sits around 44x despite having the lowest lower bound of the five, at about 0.2x.
